...
namespace SubstrateNetApiTests.Extrinsic
{
    public class MethodTest
    {
        ...
        {
            Assert.True("0x0c040602".Equals(Utils.Bytes2HexString(new Method(0x06, 0x02).Encode()), StringComparison.InvariantCultureIgnoreCase));

            Assert.True("0x2c0406000100000000000000".Equals(Utils.Bytes2HexString(new Method(0x06, 0x00, Utils.HexToByteArray("0x0100000000000000")).Encode()), StringComparison.InvariantCultureIgnoreCase));
            ...
            Assert.True("0x98040400ffd43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d9101".Equals(Utils.Bytes2HexString(balanceTransfer.Encode()), StringComparison.InvariantCultureIgnoreCase));
        }
    }
}