...
namespace SubstrateNetApi.Model.PalletBalances
{
    ...
    public sealed class BalancesCalls
    {
        ...
        public BalancesCalls(SubstrateNetApi.SubstrateClient client)
        {
            this._client = client;
        }
        ...
        {
            return new GenericExtrinsicCall(6, "Balances", 0, "transfer", dest, value);
        }
        ...
        {
            return new GenericExtrinsicCall(6, "Balances", 1, "set_balance", who, new_free, new_reserved);
        }
        ...
        {
            return new GenericExtrinsicCall(6, "Balances", 2, "force_transfer", source, dest, value);
        }
        ...
        {
            return new GenericExtrinsicCall(6, "Balances", 3, "transfer_keep_alive", dest, value);
        }
        ...
        {
            return new GenericExtrinsicCall(6, "Balances", 4, "transfer_all", dest, keep_alive);
        }
        ...
        {
            return new GenericExtrinsicCall(6, "Balances", 5, "force_unreserve", who, amount);
        }
    }
