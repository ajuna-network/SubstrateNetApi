...
namespace SubstrateNetApi.Model.PalletTreasury
{
    ...
    public sealed class TreasuryCalls
    {
        ...
        public TreasuryCalls(SubstrateNetApi.SubstrateClient client)
        {
            this._client = client;
        }
        ...
        {
            return new GenericExtrinsicCall(17, "Treasury", 0, "propose_spend", value, beneficiary);
        }
        ...
        {
            return new GenericExtrinsicCall(17, "Treasury", 1, "reject_proposal", proposal_id);
        }
        ...
        {
            return new GenericExtrinsicCall(17, "Treasury", 2, "approve_proposal", proposal_id);
        }
    }
