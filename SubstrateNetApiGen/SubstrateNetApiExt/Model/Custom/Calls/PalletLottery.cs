...
namespace SubstrateNetApi.Model.Custom.Calls
{
    ...
    public sealed class PalletLottery
    {
        ...
        /// </summary>
        public GenericExtrinsicCall BuyTicket(EnumNodeCall call)
        {
        ...
        /// </summary>
        public GenericExtrinsicCall SetCalls(BaseVec<EnumNodeCall> calls)
        {
        ...
        /// </summary>
        public GenericExtrinsicCall StartLottery(U128 price, U32 length, U32 delay, Bool repeat)
        {
