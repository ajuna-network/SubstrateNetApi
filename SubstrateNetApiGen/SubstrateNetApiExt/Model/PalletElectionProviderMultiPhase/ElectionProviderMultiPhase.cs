...
namespace SubstrateNetApi.Model.PalletElectionProviderMultiPhase
{
    ...
    public sealed class ElectionProviderMultiPhaseCalls
    {
        ...
        public ElectionProviderMultiPhaseCalls(SubstrateNetApi.SubstrateClient client)
        {
            this._client = client;
        }
        ...
        {
            return new GenericExtrinsicCall(8, "ElectionProviderMultiPhase", 0, "submit_unsigned", raw_solution, witness);
        }
        ...
        {
            return new GenericExtrinsicCall(8, "ElectionProviderMultiPhase", 1, "set_minimum_untrusted_score", maybe_next_score);
        }
        ...
        {
            return new GenericExtrinsicCall(8, "ElectionProviderMultiPhase", 2, "set_emergency_election_result", supports);
        }
        ...
        {
            return new GenericExtrinsicCall(8, "ElectionProviderMultiPhase", 3, "submit", raw_solution, num_signed_submissions);
        }
    }
