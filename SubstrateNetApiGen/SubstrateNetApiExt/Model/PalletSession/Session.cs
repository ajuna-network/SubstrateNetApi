...
namespace SubstrateNetApi.Model.PalletSession
{
    ...
    public sealed class SessionCalls
    {
        ...
        public SessionCalls(SubstrateNetApi.SubstrateClient client)
        {
            this._client = client;
        }
        ...
        {
            return new GenericExtrinsicCall(10, "Session", 0, "set_keys", keys, proof);
        }
        ...
        {
            return new GenericExtrinsicCall(10, "Session", 1, "purge_keys");
        }
    }
