...
namespace SubstrateNetApi.Model.PalletUniques
{
    ...
    public sealed class DestroyWitness : BaseType
    {
        ...
        public BaseCom<SubstrateNetApi.Model.Types.Primitive.U32> InstanceMetadatas
        {
            get
            {
        ...
        public BaseCom<SubstrateNetApi.Model.Types.Primitive.U32> Attributes
        {
            get
            {
        ...
        {
            var start = p;
            Instances = new BaseCom<SubstrateNetApi.Model.Types.Primitive.U32>();
            Instances.Decode(byteArray, ref p);
            InstanceMetadatas = new BaseCom<SubstrateNetApi.Model.Types.Primitive.U32>();
            InstanceMetadatas.Decode(byteArray, ref p);
            Attributes = new BaseCom<SubstrateNetApi.Model.Types.Primitive.U32>();
