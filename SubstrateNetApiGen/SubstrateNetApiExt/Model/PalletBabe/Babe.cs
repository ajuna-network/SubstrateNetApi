...
namespace SubstrateNetApi.Model.PalletBabe
{
    ...
    public sealed class BabeCalls
    {
        ...
        public BabeCalls(SubstrateNetApi.SubstrateClient client)
        {
            this._client = client;
        }
        ...
        {
            return new GenericExtrinsicCall(2, "Babe", 0, "report_equivocation", equivocation_proof, key_owner_proof);
        }
        ...
        {
            return new GenericExtrinsicCall(2, "Babe", 1, "report_equivocation_unsigned", equivocation_proof, key_owner_proof);
        }
        ...
        {
            return new GenericExtrinsicCall(2, "Babe", 2, "plan_config_change", config);
        }
    }
