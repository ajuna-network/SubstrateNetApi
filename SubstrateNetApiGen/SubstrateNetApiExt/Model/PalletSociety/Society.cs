...
namespace SubstrateNetApi.Model.PalletSociety
{
    ...
    public sealed class SocietyCalls
    {
        ...
        public SocietyCalls(SubstrateNetApi.SubstrateClient client)
        {
            this._client = client;
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 0, "bid", value);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 1, "unbid", pos);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 2, "vouch", who, value, tip);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 3, "unvouch", pos);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 4, "vote", candidate, approve);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 5, "defender_vote", approve);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 6, "payout");
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 7, "found", founder, max_members, rules);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 8, "unfound");
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 9, "judge_suspended_member", who, forgive);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 10, "judge_suspended_candidate", who, judgement);
        }
        ...
        {
            return new GenericExtrinsicCall(26, "Society", 11, "set_max_members", max);
        }
    }
