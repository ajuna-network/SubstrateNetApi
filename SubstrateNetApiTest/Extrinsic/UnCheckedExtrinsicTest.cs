...
namespace SubstrateNetApiTests.Extrinsic
{
    public class UnCheckedExtrinsicTest
    {
        ...
        public void BalanceTransferMockedTest1()
        {
            ...
            var uncheckedExtrinsic = new UnCheckedExtrinsic(true, new Account(KeyType.ED25519, new byte[0], publicKey), nonce, method, genesisHash, currentBlockHash, currentBlockNumber, tip);
        ...
        public void BalanceTransferAliceTest()
        {
            ...
            var uncheckedExtrinsic = new UnCheckedExtrinsic(true, new Account(KeyType.SR25519, new byte[0],  publicKey), nonce, method, genesisHash, startEra, currentBlockNumber, tip);
        ...
        public void DmogCreateImmortalAliceTest()
        {
            ...
            var uncheckedExtrinsic = new UnCheckedExtrinsic(true, new Account(KeyType.SR25519, new byte[0], publicKey), nonce, method, genesisHash, currentBlockHash, currentBlockNumber, tip);
