...
namespace SubstrateNetApiTests
{
    public class TypeEncodingTest
    {
        ...
        public void VecU8EncodingTest()
        {
            ...
            var t1 = new PrimU8(); t1.Create(actual.Value[0].Value);
            var t2 = new PrimU8(); t2.Create(actual.Value[1].Value);
            var t3 = new PrimU8(); t3.Create(actual.Value[2].Value);
            var t4 = new PrimU8(); t4.Create(actual.Value[3].Value);
            var t5 = new PrimU8(); t5.Create(actual.Value[4].Value);
            var t6 = new PrimU8(); t6.Create(actual.Value[5].Value);
            var t7 = new PrimU8(); t7.Create(actual.Value[6].Value);
            var t8 = new PrimU8(); t8.Create(actual.Value[7].Value);

            List <PrimU8> list = new List<PrimU8>()
            {
                t1,t2,t3,t4,t5,t6,t7,t8
            };

            var vecU8 = new Vec<PrimU8>();
            vecU8.Create(list);
        ...
        {
            var optionU8Null = new Option<PrimU8>();
            var optionU8One = new Option<PrimU8>();
        ...
        {
            var extEnumType = new BaseEnumExt<PhaseState, PrimU8, NullType, NullType, NullType, NullType, NullType, NullType, NullType, NullType>();
            ...
            Assert.AreEqual(1, (extEnumType.Value2 as PrimU8).Value);
